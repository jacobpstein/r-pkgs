...
You need to install the Xcode command line tools, which requires that you [register as an Apple developer](https://developer.apple.com/programs/enroll/) (just log-in and register with your Apple ID; there is a paid certificate, but you don't need to sign up for that).
